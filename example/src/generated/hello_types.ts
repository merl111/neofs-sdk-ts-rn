...
export class HelloRequestImpl implements HelloRequest {
  ...
  constructor(data?: Partial<HelloRequest>) {
  ...
  static deserializeBinary(data: Uint8Array): HelloRequestImpl {
    const reader = new BinaryReader(data);
    const message = new HelloRequestImpl();
...
export class HelloResponseImpl implements HelloResponse {
  Reply!: string;
  ...
  static deserializeBinary(data: Uint8Array): HelloResponseImpl {
    const reader = new BinaryReader(data);
    const message = new HelloResponseImpl();
