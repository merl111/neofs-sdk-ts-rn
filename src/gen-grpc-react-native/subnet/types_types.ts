...
// Generated from: subnet/types.proto
...
export namespace NeoFsV2Subnet {

export interface SubnetInfo {
  Id?: NeoFsV2Refs.SubnetID;
  Owner?: NeoFsV2Refs.OwnerID;
}

export class SubnetInfoImpl implements SubnetInfo {
  Id?: NeoFsV2Refs.SubnetID;
  Owner?: NeoFsV2Refs.OwnerID;

  constructor(data?: Partial<SubnetInfo>) {
  ...
  serializeBinary(): Uint8Array {
    ...
    if (this.Owner) {
      writer.writeMessage(2, this.Owner);
    }
    return writer.getResultBuffer();
  }

  static deserializeBinary(data: Uint8Array): SubnetInfoImpl {
    const reader = new BinaryReader(data);
    const message = new SubnetInfoImpl();
      ...
      switch (fieldNumber) {
        case 1: // Id
          if (wireType === 2) { // Length-delimited
            message.Id = reader.readMessage(NeoFsV2Refs.SubnetIDImpl.deserializeBinary);
          } else {
        ...
        case 2: // Owner
          if (wireType === 2) { // Length-delimited
            message.Owner = reader.readMessage(NeoFsV2Refs.OwnerIDImpl.deserializeBinary);
          } else {
            reader.skipField(wireType);
          }
          break;
