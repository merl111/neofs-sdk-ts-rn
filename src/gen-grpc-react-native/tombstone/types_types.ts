...
// Generated from: tombstone/types.proto
...
export namespace NeoFsV2Tombstone {
...
export class TombstoneImpl implements Tombstone {
  ExpirationEpoch!: bigint;
  SplitId!: Uint8Array;
  Members!: NeoFsV2Refs.ObjectID[];

  constructor(data?: Partial<Tombstone>) {
  ...
  serializeBinary(): Uint8Array {
    ...
    if (this.ExpirationEpoch !== 0n) {
      writer.writeUint64(1, this.ExpirationEpoch);
    }
    if (this.SplitId.length > 0) {
      writer.writeBytes(2, this.SplitId);
    }
  ...
  static deserializeBinary(data: Uint8Array): TombstoneImpl {
    const reader = new BinaryReader(data);
    const message = new TombstoneImpl();
