...
// Generated from: accounting/types.proto
...
export namespace NeoFsV2Accounting {
...
export class DecimalImpl implements Decimal {
  Value!: bigint;
  Precision!: number;

  constructor(data?: Partial<Decimal>) {
  ...
  static deserializeBinary(data: Uint8Array): DecimalImpl {
    const reader = new BinaryReader(data);
    const message = new DecimalImpl();
      ...
      switch (fieldNumber) {
        case 1: // Value
          if (wireType === 0) { // Varint
            ...
            message.Value = reader.readInt64Fixed();
          } else {
        ...
        case 2: // Precision
          if (wireType === 0) { // Varint
            ...
            message.Precision = reader.readUint32Fixed();
          } else {
            reader.skipField(wireType);
          }
          break;
